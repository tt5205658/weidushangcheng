...
public class ComleteOrderFromDataAdapter extends RecyclerView.Adapter<ComleteOrderFromDataAdapter.ViewHodel> {
    ...
    public ComleteOrderFromDataAdapter(Context mContext) {
