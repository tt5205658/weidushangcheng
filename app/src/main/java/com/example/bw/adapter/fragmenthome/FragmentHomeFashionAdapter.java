...
public class FragmentHomeFashionAdapter extends RecyclerView.Adapter<FragmentHomeFashionAdapter.ViewHodel> {



    private List<HomeShoppingBean.ResultBean.MlssBean.CommodityListBeanXX> mlssBeanList;
    private Context mContext;

    public FragmentHomeFashionAdapter(Context mContext) {
        this.mContext = mContext;
        mlssBeanList = new ArrayList<>();
    }

    public void setMlssBeanList(List<HomeShoppingBean.ResultBean.MlssBean.CommodityListBeanXX> list) {
        mlssBeanList = list;
    ...
    public ViewHodel onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = View.inflate(mContext, R.layout.item_fragment_home_fashion, null);
